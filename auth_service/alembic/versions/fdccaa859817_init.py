...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['role_id'],
            ['roles.id'],
            name=op.f('users_roles_role_id_fkey'),
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['user_id'],
            ['users.id'],
            name=op.f('users_roles_user_id_fkey'),
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            'auth_date', postgresql.TIMESTAMP(), autoincrement=False, nullable=False
        ),
        sa.Column('user_id', sa.UUID(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ['user_id'],
            ['users.id'],
            name=op.f('users_auth_history_user_id_fkey'),
            ondelete='CASCADE',
        ),
