...
from auth_service.src.db.postgres import Base, get_session
from auth_service.src.main import app
from auth_service.src.models import entity, social_account  # Import all models
...
async def clear_cached_services():
    ...
    yield # Эта фикстура теперь только очищает кеш lru_cache
