...
from auth_service.src.api.v1 import auth, roles, users, social_auth
from auth_service.src.core.logger import app_logger
from auth_service.src.core.config import settings
from auth_service.src.db import redis as redis_db
from auth_service.src.db import postgres as postgres_db
...
@app.middleware('http')
async def before_request(request: Request, call_next): # Добавлено async
